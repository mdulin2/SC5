	...
	&& $_REQUEST['student_id'] !== 'new' )
{
	...
	// SecDo: Remove this to make it possible to view student information across accounts
...
// http://localhost/Modules.php?modname=Students/Student.php&student_id=12345
